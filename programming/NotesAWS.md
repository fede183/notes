...
## AWS Direct Connect
Service that lets you establish a dedicated private connection between your data center and a VPC.
...
### AWS responsibility
Protects the infrastructure that runs all the services offered in the AWS Cloud.
